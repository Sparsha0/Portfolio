    ...
    return (
        <div className="flex flex-col rounded-2xl relative">
            <div className="flex flex-row md:flex-col md:items-center px-2 sm:px-4 gap-3 p-4 ">
                <img src={process.env.PUBLIC_URL + "/images/sparsha.png"} className="w-20 h-24 sm:w-24 sm:h-38 md:w-38 md:h-52 md:mt-14 border-gray-900 rounded-2xl shadow-2xl" alt="sparsha sawant" />
