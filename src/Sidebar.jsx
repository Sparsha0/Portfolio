        ...
        <div className="flex flex-col rounded-2xl relative">
            <div className="flex flex-row md:flex-col md:items-center px-2 sm:px-4 gap-3 p-4 ">
                ...
                <div className="flex flex-col space-x-1 gap-1">
                    <p className=" text-lg sm:text-xl ms:text-3xl md:mt-3 font-bold text-shadow-lg text-warp">Sparsha Sawant</p>
                    <p className="text-sm ring-white border-2 md:px-5 rounded-md md:text-l bg-gray-900 md:mt-3 test-wrap">Web developer</p>
